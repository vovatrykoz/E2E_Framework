...
public:
    ...
    /**
     * @brief Returns a copy of the task instances in the timed path.
     * 
     * Creates and returns a vector containing all TaskInstance objects in the path.
     * 
     * @return A vector containing a copy of the task instances.
     */
